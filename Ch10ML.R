...
##same as the base command above just in Caret syntax
...
#Using recipe to help with pre processing of data which is incorporated into the train() call
...
#Above doesnt transform the data what we do below does
...
#Visualizing missing data to deal with it
...
#Could drop LW_IN as it's missing a lot of data and not thought to affect gpp
...
#Replacing catagorical data with numberic
...
#Looking at windspeed and a log transformation
